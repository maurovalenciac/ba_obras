window.SLIDES_DATA = [
    ...
    {
		title: 'Encuentro cercano con la Ciudad',
		order: 5,
		category: 'cercana',
		slides: [
			{
				title: 'Encuentro cercano con la Ciudad',
				description: 'Una ciudad es cercana cuando viajar de un extremo al otro es sencillo, accesible y sustentable.',
				type: 'image', 
                url:'https://media.giphy.com/media/MrmgBz2qYDtOE/giphy.gif'
			},
            {
				title: '',
				description: 'La construcción del Metrobús en las principales arterias de Buenos Aires contribuye a que todos cuenten con transporte transporte público cómodo y rápido para que vayas a donde quieras, cuando quieras, sin tardar más de lo necesario. Porque la Ciudad es tuya.',
				type: 'map', 
                url:'http://epok.buenosaires.gob.ar/pub/mapa/sociopublico/ciudad_cercana/'
			}
		]
	},
    {
